    ...
    def analyze(self, sender=None):
        ...
        def worker():
            try:
                ...
                self.set_status("Extraction et nettoyage du dernier échange…")
                ...
                self.set_status("Terminé. Les deux blocs sont prêts à copier.")
            except Exception as exc:
                self.set_status("Analyse impossible : " + str(exc)[:115])
