    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                ...
                name = input("Nom du script (laisser vide pour le nom du fichier) : ").strip() or None
                category = input("Catégorie (laisser vide pour Général) : ").strip() or None
